namespace Macabre2D.Engine.Windows.Editor {

    using log4net;
    using Macabre2D.Engine.Windows.Common;
    using Macabre2D.Engine.Windows.Editor.Properties;
    using Macabre2D.Engine.Windows.ServiceInterfaces;
    using Macabre2D.Engine.Windows.Services;
    using Macabre2D.Engine.Windows.Views;
    using System;
    using System.Linq;
