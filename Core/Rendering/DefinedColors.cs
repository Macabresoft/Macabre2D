namespace Macabresoft.MonoGame.Core {
    ...
    public static class DefinedColors {
        ...
        /// A cosmic teal color.
        /// </summary>
        public static Color CosmicJam = new Color(53, 108, 119);

        /// <summary>
        /// A not-quite-black color with a hint of <see cref="MacabresoftPurple" />.
        /// </summary>
        public static Color MacabresoftBlack = new Color(30, 15, 15);

        /// <summary>
        /// A not-quite-white color as seen in Macabresoft's skull logo.
        /// </summary>
        public static Color MacabresoftBone = new Color(227, 218, 201);

        /// <summary>
        /// The purple seen in Macabresoft's logo.
        /// </summary>
        public static Color MacabresoftPurple = new Color(99, 73, 96);

        /// <summary>
        /// A red that inspires revolution.
        /// </summary>
        public static Color MacabresoftRed = new Color(130, 38, 38);

        /// <summary>
        /// The yellow seen in Macabresoft's logo.
        /// </summary>
        public static Color MacabresoftYellow = new Color(200, 171, 55);

        /// <summary>
        /// A terminal-like green used in the tuner made by Macabresoft. The tuner was originally
        /// named "Zvukosti Tuner".
        /// </summary>
        public static Color ZvukostiGreen = new Color(113, 237, 100);
    }
}