...
public sealed class AudioPlayer : Entity {
    ...
    public override void Initialize(IScene scene, IEntity parent) {
        ...
        this._instance = this.AudioClipReference.InitializeAndGetInstance(this.Scene.Assets, this.Game.Project.Settings.DefaultAudioSettings, this.Volume, this.Pan, this.Pitch, this.ShouldLoop);
    ...
    private void AudioClipReference_PropertyChanged(object? sender, PropertyChangedEventArgs e) {
        if (e.PropertyName == nameof(this.AudioClipReference.Asset)) {
            if (this.AudioClipReference.Asset is { } audioClip) {
                ...
                this._instance = audioClip.GetInstance(this.Game.Project.Settings.DefaultAudioSettings, this.Volume, this.Pan, this.Pitch, this.ShouldLoop);
            }
        }
    }
}