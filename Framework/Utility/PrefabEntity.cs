...
////    public sealed class PrefabComponent : GameRenderableComponent, IAssetComponent<Prefab> {
...
////            get {
////                return this.Prefrab?.Entity is IBoundable boundable ? boundable.BoundingArea : new BoundingArea();
////            }
////        }
...
////                    if (this._prefab?.Entity != null && this.IsInitialized) {
////                        this._prefab.Entity.Initialize(this.Scene);
////                    }
...
////            var component = this.Prefrab?.Entity;
////            if (component != null) {
...
////                this.Prefrab?.Entity?.LoadContent();
////            }
...
////            if (this.Prefrab?.Entity is BaseComponent component) {
