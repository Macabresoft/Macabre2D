...
public class TextLineRenderer : BaseSpriteSheetFontRenderer, IScreenSpaceRenderer, IUpdateableEntity {
    ...
    protected virtual BoundingArea CreateBoundingArea() {
        ...
        if (this.CouldLegacyTextBeVisible()) {
            boundingArea = this.RenderOptions.CreateBoundingAreaFromScreenSpace(this);
        }
    ...
    protected override IEnumerable<IAssetReference> GetAssetReferences() {
        ...
        yield return this.LegacyFontReference;
    }
    ...
    private void ResetTextLine() {
        ...
        if (this.Font != null) {
            ...
            if (this.ShouldRenderLegacyFont &&
                ...
                var size = new Vector2(this.WidthOverride.IsEnabled ? this.WidthOverride.Value : this._textLine.Width, this._characterHeight);
                this._legacyTextLine = new LegacyTextLine(legacyFontAsset, this.Game.UnitsPerScreenPixel, this._legacyFontScale, size, actualText, this.WidthOverride.IsEnabled);
            }
            else {
