...
/// </summary>
public interface ISystemService : ISelectionService<ISceneSystem> {
    /// <summary>
...
/// </summary>
public class SystemService : SelectionService<ISceneSystem>, ISystemService {
    /// <summary>
    ...
    public SystemService(
        ...
        this.AvailableTypes = this.AssemblyService.LoadTypes(typeof(ISceneSystem)).Where(x =>
