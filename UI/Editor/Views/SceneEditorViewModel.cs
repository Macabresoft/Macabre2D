...
public sealed class SceneEditorViewModel : BaseViewModel {
    ...
    private IScene CreateScene() {
        ...
        this._camera.AddChild(new SceneBoundingAreaDrawer(this._editorService, this.SceneService));
        ...
        scene.AddSystem(new EditorSceneUpdateSystem(this._entityService, this.SceneService, selectorGizmo));
        return scene;
    }
