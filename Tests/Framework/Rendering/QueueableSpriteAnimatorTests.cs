...
public static class QueueableSpriteAnimatorTests {
    ...
    public static void QueueableSpriteAnimator_LoopingTest() {
        var animation = CreateAnimation(3, true, out var animator, out var gameTime, out var frameTime);
    ...
    public static void Update_ShouldTriggerOnAnimationFinished_WhenAnimationFinished() {
        var animation = CreateAnimation(1, false, out var animator, out var gameTime, out var frameTime);
    ...
    public static void Stop_ShouldTriggerOnAnimationFinished() {
        var animation = CreateAnimation(1, true, out var animator, out var gameTime, out _);
        var isFinished = false;
        SpriteAnimation finishedAnimation = null;
        animator.OnAnimationFinished += (_, spriteAnimation) =>
        {
    ...
    public static void Play_ShouldTriggerOnAnimationFinished() {
        var animation = CreateAnimation(1, false, out var animator, out var gameTime, out _);
        var secondAnimation = CreateAnimation(5, false, out _, out _, out _);
        var isFinished = false;
        SpriteAnimation finishedAnimation = null;
        animator.OnAnimationFinished += (_, spriteAnimation) =>
        {
    ...
    public static void Update_ShouldNotTriggerOnAnimationFinished_WhenLooping() {
        CreateAnimation(1, true, out var animator, out var gameTime, out var frameTime);
        var isFinished = false;
        SpriteAnimation finishedAnimation = null;
        animator.OnAnimationFinished += (_, spriteAnimation) =>
        {
    ...
    public static void Update_ShouldNotTriggerOnAnimationFinished_WhenAnimationNotFinished() {
        CreateAnimation(1, false, out var animator, out var gameTime, out var frameTime);
        var isFinished = false;
        SpriteAnimation finishedAnimation = null;
        animator.OnAnimationFinished += (_, spriteAnimation) =>
        {
    ...
    private static SpriteAnimation CreateAnimation(byte numberOfSteps, bool isLooping, out QueueableSpriteAnimator animator, out GameTime gameTime, out FrameTime frameTime) {
