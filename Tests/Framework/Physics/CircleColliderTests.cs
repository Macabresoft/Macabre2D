namespace Macabresoft.Macabre2D.Tests.Core.Physics {
    ...
    public static class CircleColliderTests {
        ...
        public static void CircleCollider_CollidesWithCircleTest(float x1, float y1, float r1, float x2, float y2, float r2, bool collisionOccured) {
            ...
            circleBody1.Entity.SetWorldPosition(new Vector2(x1, y1));
            circleBody1.Collider = new CircleCollider(r1);

            circleBody2.Entity.SetWorldPosition(new Vector2(x2, y2));
            ...
            if (collisionOccured) {
                ...
                var originalPosition = circleBody1.Entity.Transform.Position;
                circleBody1.Entity.SetWorldPosition(originalPosition + collision1.MinimumTranslationVector);
                Assert.False(circleBody1.Collider.CollidesWith(circleBody2.Collider, out collision1));
                circleBody1.Entity.SetWorldPosition(originalPosition);

                circleBody2.Entity.SetWorldPosition(circleBody2.Entity.Transform.Position + collision2.MinimumTranslationVector);
        ...
        public static void CircleCollider_CollidesWithQuadTest(float x1, float y1, float r1, float x2, float y2, float w, float h, bool collisionOccured) {
            ...
            quadBody.Entity.SetWorldPosition(new Vector2(x2, y2));
            ...
            if (collisionOccured) {
                ...
                quadBody.Entity.SetWorldPosition(quadBody.Entity.Transform.Position + collision2.MinimumTranslationVector);
